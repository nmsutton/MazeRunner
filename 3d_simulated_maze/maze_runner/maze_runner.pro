...
unrealRootPath=/CompNeuro/Software/UnrealEngine
maze_runnerRootPath=/CompNeuro/Software/MazeRunner/3d_simulated_maze/maze_runner

gameProjectFile=/CompNeuro/Software/MazeRunner/3d_simulated_maze/maze_runner/maze_runner.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(maze_runnerSource.pri)
include(maze_runnerHeader.pri)
include(maze_runnerConfig.pri)
include(maze_runnerIncludes.pri)
include(maze_runnerDefines.pri)
...
maze_runner-Linux-Debug.commands = $$build maze_runner Linux Debug  -project="\"$$gameProjectFile\"" $$args
maze_runner-Linux-DebugGame.commands = $$build maze_runner Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
maze_runner-Linux-Shipping.commands = $$build maze_runner Linux Shipping  -project="\"$$gameProjectFile\"" $$args
maze_runner-Linux-Test.commands = $$build maze_runner Linux Test  -project="\"$$gameProjectFile\"" $$args
maze_runner.commands = $$build maze_runner Linux Development  -project="\"$$gameProjectFile\"" $$args

maze_runnerEditor-Linux-Debug.commands = $$build maze_runnerEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
maze_runnerEditor-Linux-DebugGame.commands = $$build maze_runnerEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
maze_runnerEditor-Linux-Shipping.commands = $$build maze_runnerEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
maze_runnerEditor-Linux-Test.commands = $$build maze_runnerEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
maze_runnerEditor.commands = $$build maze_runnerEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	maze_runner-Linux-Debug \
	maze_runner-Linux-DebugGame \
	maze_runner-Linux-Shipping \
	maze_runner-Linux-Test \
	maze_runner \
	maze_runnerEditor-Linux-Debug \
	maze_runnerEditor-Linux-DebugGame \
	maze_runnerEditor-Linux-Shipping \
	maze_runnerEditor-Linux-Test \
	maze_runnerEditor \
